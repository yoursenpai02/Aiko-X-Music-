...
class BUTTONS(object):
    ...
    InlineKeyboardButton("𝗔𝗖𝗧𝗜𝗢𝗡", callback_data="mplus HELP_Action"),InlineKeyboardButton("𝗦𝗘𝗔𝗥𝗖𝗛", callback_data="mplus HELP_Search")],    
    ...
    InlineKeyboardButton("𝗧𝗥𝗨𝗧𝗛-𝗗𝗔𝗥𝗘", callback_data="mplus HELP_TD"),InlineKeyboardButton("𝗛𝗔𝗦𝗧𝗔𝗚", callback_data="mplus HELP_HT")], 
